...
const (
	...
	ResponseServiceName = "collection.item.response.v1.ResponseService"
)
...
const (
	...
	// ResponseGet RPC.
	ResponseServiceResponseGetProcedure = "/collection.item.response.v1.ResponseService/ResponseGet"
	// ResponseServiceResponseHeaderListProcedure is the fully-qualified name of the ResponseService's
	// ResponseHeaderList RPC.
	ResponseServiceResponseHeaderListProcedure = "/collection.item.response.v1.ResponseService/ResponseHeaderList"
	// ResponseServiceResponseAssertListProcedure is the fully-qualified name of the ResponseService's
	// ResponseAssertList RPC.
	ResponseServiceResponseAssertListProcedure = "/collection.item.response.v1.ResponseService/ResponseAssertList"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	responseServiceServiceDescriptor                  = v1.File_collection_item_response_v1_response_proto.Services().ByName("ResponseService")
...
// ResponseServiceClient is a client for the collection.item.response.v1.ResponseService service.
...
// NewResponseServiceClient constructs a client for the collection.item.response.v1.ResponseService
...
// ResponseGet calls collection.item.response.v1.ResponseService.ResponseGet.
...
// ResponseHeaderList calls collection.item.response.v1.ResponseService.ResponseHeaderList.
...
// ResponseAssertList calls collection.item.response.v1.ResponseService.ResponseAssertList.
...
// ResponseServiceHandler is an implementation of the collection.item.response.v1.ResponseService
// service.
...
func NewResponseServiceHandler(svc ResponseServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/collection.item.response.v1.ResponseService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedResponseServiceHandler) ResponseGet(context.Context, *connect.Request[v1.ResponseGetRequest]) (*connect.Response[v1.ResponseGetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.item.response.v1.ResponseService.ResponseGet is not implemented"))
}
...
func (UnimplementedResponseServiceHandler) ResponseHeaderList(context.Context, *connect.Request[v1.ResponseHeaderListRequest]) (*connect.Response[v1.ResponseHeaderListResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.item.response.v1.ResponseService.ResponseHeaderList is not implemented"))
}
...
func (UnimplementedResponseServiceHandler) ResponseAssertList(context.Context, *connect.Request[v1.ResponseAssertListRequest]) (*connect.Response[v1.ResponseAssertListResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.item.response.v1.ResponseService.ResponseAssertList is not implemented"))
}
