...
const (
	...
	// RPC.
	AuthServiceAuthMagicLinkProcedure = "/auth.v1.AuthService/AuthMagicLink"
...
// AuthMagicLink calls auth.v1.AuthService.AuthMagicLink.
...
func (UnimplementedAuthServiceHandler) AuthMagicLink(context.Context, *connect.Request[v1.AuthMagicLinkRequest]) (*connect.Response[v1.AuthMagicLinkResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("auth.v1.AuthService.AuthMagicLink is not implemented"))
}
