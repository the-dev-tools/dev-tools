...
const (
	...
	EndpointServiceName = "collection.item.endpoint.v1.endpointv1.EndpointService"
)
...
const (
	...
	// EndpointGet RPC.
	EndpointServiceEndpointGetProcedure = "/collection.item.endpoint.v1.endpointv1.EndpointService/EndpointGet"
	// EndpointServiceEndpointCreateProcedure is the fully-qualified name of the EndpointService's
	// EndpointCreate RPC.
	EndpointServiceEndpointCreateProcedure = "/collection.item.endpoint.v1.endpointv1.EndpointService/EndpointCreate"
	// EndpointServiceEndpointUpdateProcedure is the fully-qualified name of the EndpointService's
	// EndpointUpdate RPC.
	EndpointServiceEndpointUpdateProcedure = "/collection.item.endpoint.v1.endpointv1.EndpointService/EndpointUpdate"
	// EndpointServiceEndpointDeleteProcedure is the fully-qualified name of the EndpointService's
	// EndpointDelete RPC.
	EndpointServiceEndpointDeleteProcedure = "/collection.item.endpoint.v1.endpointv1.EndpointService/EndpointDelete"
	// EndpointServiceEndpointDuplicateProcedure is the fully-qualified name of the EndpointService's
	// EndpointDuplicate RPC.
	EndpointServiceEndpointDuplicateProcedure = "/collection.item.endpoint.v1.endpointv1.EndpointService/EndpointDuplicate"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	endpointServiceServiceDescriptor                 = v1.File_collection_item_endpoint_v1_endpointv1_proto.Services().ByName("EndpointService")
...
// EndpointServiceClient is a client for the collection.item.endpoint.v1.endpointv1.EndpointService
// service.
...
// NewEndpointServiceClient constructs a client for the
// collection.item.endpoint.v1.endpointv1.EndpointService service. By default, it uses the Connect
...
// EndpointGet calls collection.item.endpoint.v1.endpointv1.EndpointService.EndpointGet.
...
// EndpointCreate calls collection.item.endpoint.v1.endpointv1.EndpointService.EndpointCreate.
...
// EndpointUpdate calls collection.item.endpoint.v1.endpointv1.EndpointService.EndpointUpdate.
...
// EndpointDelete calls collection.item.endpoint.v1.endpointv1.EndpointService.EndpointDelete.
...
// EndpointDuplicate calls collection.item.endpoint.v1.endpointv1.EndpointService.EndpointDuplicate.
...
// EndpointServiceHandler is an implementation of the
// collection.item.endpoint.v1.endpointv1.EndpointService service.
...
func NewEndpointServiceHandler(svc EndpointServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/collection.item.endpoint.v1.endpointv1.EndpointService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedEndpointServiceHandler) EndpointGet(context.Context, *connect.Request[v1.EndpointGetRequest]) (*connect.Response[v1.EndpointGetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.item.endpoint.v1.endpointv1.EndpointService.EndpointGet is not implemented"))
}
...
func (UnimplementedEndpointServiceHandler) EndpointCreate(context.Context, *connect.Request[v1.EndpointCreateRequest]) (*connect.Response[v1.EndpointCreateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.item.endpoint.v1.endpointv1.EndpointService.EndpointCreate is not implemented"))
}
...
func (UnimplementedEndpointServiceHandler) EndpointUpdate(context.Context, *connect.Request[v1.EndpointUpdateRequest]) (*connect.Response[v1.EndpointUpdateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.item.endpoint.v1.endpointv1.EndpointService.EndpointUpdate is not implemented"))
}
...
func (UnimplementedEndpointServiceHandler) EndpointDelete(context.Context, *connect.Request[v1.EndpointDeleteRequest]) (*connect.Response[v1.EndpointDeleteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.item.endpoint.v1.endpointv1.EndpointService.EndpointDelete is not implemented"))
}
...
func (UnimplementedEndpointServiceHandler) EndpointDuplicate(context.Context, *connect.Request[v1.EndpointDuplicateRequest]) (*connect.Response[v1.EndpointDuplicateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.item.endpoint.v1.endpointv1.EndpointService.EndpointDuplicate is not implemented"))
}
