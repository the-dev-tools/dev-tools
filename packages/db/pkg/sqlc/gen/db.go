...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.getHeaderByPrevNextStmt, err = db.PrepareContext(ctx, getHeaderByPrevNext); err != nil {
		return nil, fmt.Errorf("error preparing query GetHeaderByPrevNext: %w", err)
	}
	...
	if q.getQueriesByExampleIDOrderedStmt, err = db.PrepareContext(ctx, getQueriesByExampleIDOrdered); err != nil {
		return nil, fmt.Errorf("error preparing query GetQueriesByExampleIDOrdered: %w", err)
	}
	...
	if q.getQueryByPrevNextStmt, err = db.PrepareContext(ctx, getQueryByPrevNext); err != nil {
		return nil, fmt.Errorf("error preparing query GetQueryByPrevNext: %w", err)
	}
	...
	if q.updateQueryNextStmt, err = db.PrepareContext(ctx, updateQueryNext); err != nil {
		return nil, fmt.Errorf("error preparing query UpdateQueryNext: %w", err)
	}
	if q.updateQueryOrderStmt, err = db.PrepareContext(ctx, updateQueryOrder); err != nil {
		return nil, fmt.Errorf("error preparing query UpdateQueryOrder: %w", err)
	}
	if q.updateQueryPrevStmt, err = db.PrepareContext(ctx, updateQueryPrev); err != nil {
		return nil, fmt.Errorf("error preparing query UpdateQueryPrev: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.getHeaderByPrevNextStmt != nil {
		if cerr := q.getHeaderByPrevNextStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getHeaderByPrevNextStmt: %w", cerr)
		}
	}
	...
	if q.getQueriesByExampleIDOrderedStmt != nil {
		if cerr := q.getQueriesByExampleIDOrderedStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getQueriesByExampleIDOrderedStmt: %w", cerr)
		}
	}
	...
	if q.getQueryByPrevNextStmt != nil {
		if cerr := q.getQueryByPrevNextStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getQueryByPrevNextStmt: %w", cerr)
		}
	}
	if q.getTagStmt != nil {
	...
	if q.updateQueryNextStmt != nil {
		if cerr := q.updateQueryNextStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing updateQueryNextStmt: %w", cerr)
		}
	}
	if q.updateQueryOrderStmt != nil {
		if cerr := q.updateQueryOrderStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing updateQueryOrderStmt: %w", cerr)
		}
	}
	if q.updateQueryPrevStmt != nil {
		if cerr := q.updateQueryPrevStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing updateQueryPrevStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	getHeaderByPrevNextStmt                               *sql.Stmt
	...
	getQueriesByExampleIDOrderedStmt                      *sql.Stmt
	getQueryStmt                                          *sql.Stmt
	getQueryByDeltaParentIDStmt                           *sql.Stmt
	getQueryByPrevNextStmt                                *sql.Stmt
	getTagStmt                                            *sql.Stmt
	...
	updateQueryNextStmt                                   *sql.Stmt
	updateQueryOrderStmt                                  *sql.Stmt
	updateQueryPrevStmt                                   *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		getHeaderByPrevNextStmt:                          q.getHeaderByPrevNextStmt,
		...
		getQueriesByExampleIDOrderedStmt:                    q.getQueriesByExampleIDOrderedStmt,
		getQueryStmt:                                        q.getQueryStmt,
		getQueryByDeltaParentIDStmt:                         q.getQueryByDeltaParentIDStmt,
		getQueryByPrevNextStmt:                              q.getQueryByPrevNextStmt,
		...
		updateQueryNextStmt:                                 q.updateQueryNextStmt,
		updateQueryOrderStmt:                                q.updateQueryOrderStmt,
		updateQueryPrevStmt:                                 q.updateQueryPrevStmt,
