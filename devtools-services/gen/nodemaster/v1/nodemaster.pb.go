...
var file_nodemaster_v1_nodemaster_proto_rawDesc = []byte{
	...
	0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x32, 0x73, 0x0a, 0x11,
	0x4e, 0x6f, 0x64, 0x65, 0x4d, 0x61, 0x73, 0x74, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x12, 0x5e, 0x0a, 0x03, 0x52, 0x75, 0x6e, 0x12, 0x2a, 0x2e, 0x6e, 0x6f, 0x64, 0x65, 0x6d,
	...
	0x65, 0x42, 0x32, 0x5a, 0x30, 0x64, 0x65, 0x76, 0x74, 0x6f, 0x6f, 0x6c, 0x73, 0x2d, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x6e, 0x6f, 0x64, 0x65, 0x6d,
	0x61, 0x73, 0x74, 0x65, 0x72, 0x2f, 0x76, 0x31, 0x3b, 0x6e, 0x6f, 0x64, 0x65, 0x6d, 0x61, 0x73,
...
var file_nodemaster_v1_nodemaster_proto_goTypes = []interface{}{
...
func file_nodemaster_v1_nodemaster_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_nodemaster_v1_nodemaster_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_nodemaster_v1_nodemaster_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Node); i {
			case 0:
				return &v.state
			case 1:
		...
		file_nodemaster_v1_nodemaster_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Edges); i {
			case 0:
				return &v.state
			case 1:
		...
		file_nodemaster_v1_nodemaster_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
