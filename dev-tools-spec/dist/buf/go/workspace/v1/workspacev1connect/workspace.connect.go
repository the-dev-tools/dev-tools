...
const (
	...
	// WorkspaceList RPC.
	WorkspaceServiceWorkspaceListProcedure = "/workspace.v1.WorkspaceService/WorkspaceList"
	// WorkspaceServiceWorkspaceGetProcedure is the fully-qualified name of the WorkspaceService's
	// WorkspaceGet RPC.
	WorkspaceServiceWorkspaceGetProcedure = "/workspace.v1.WorkspaceService/WorkspaceGet"
	// WorkspaceServiceWorkspaceCreateProcedure is the fully-qualified name of the WorkspaceService's
	// WorkspaceCreate RPC.
	WorkspaceServiceWorkspaceCreateProcedure = "/workspace.v1.WorkspaceService/WorkspaceCreate"
	// WorkspaceServiceWorkspaceUpdateProcedure is the fully-qualified name of the WorkspaceService's
	// WorkspaceUpdate RPC.
	WorkspaceServiceWorkspaceUpdateProcedure = "/workspace.v1.WorkspaceService/WorkspaceUpdate"
	// WorkspaceServiceWorkspaceDeleteProcedure is the fully-qualified name of the WorkspaceService's
	// WorkspaceDelete RPC.
	WorkspaceServiceWorkspaceDeleteProcedure = "/workspace.v1.WorkspaceService/WorkspaceDelete"
	...
	WorkspaceServiceWorkspaceMemberListProcedure = "/workspace.v1.WorkspaceService/WorkspaceMemberList"
	...
	WorkspaceServiceWorkspaceMemberCreateProcedure = "/workspace.v1.WorkspaceService/WorkspaceMemberCreate"
	...
	WorkspaceServiceWorkspaceMemberUpdateProcedure = "/workspace.v1.WorkspaceService/WorkspaceMemberUpdate"
	...
	WorkspaceServiceWorkspaceMemberDeleteProcedure = "/workspace.v1.WorkspaceService/WorkspaceMemberDelete"
)
...
// WorkspaceList calls workspace.v1.WorkspaceService.WorkspaceList.
...
// WorkspaceGet calls workspace.v1.WorkspaceService.WorkspaceGet.
...
// WorkspaceCreate calls workspace.v1.WorkspaceService.WorkspaceCreate.
...
// WorkspaceUpdate calls workspace.v1.WorkspaceService.WorkspaceUpdate.
...
// WorkspaceDelete calls workspace.v1.WorkspaceService.WorkspaceDelete.
...
// WorkspaceMemberList calls workspace.v1.WorkspaceService.WorkspaceMemberList.
...
// WorkspaceMemberCreate calls workspace.v1.WorkspaceService.WorkspaceMemberCreate.
...
// WorkspaceMemberUpdate calls workspace.v1.WorkspaceService.WorkspaceMemberUpdate.
...
// WorkspaceMemberDelete calls workspace.v1.WorkspaceService.WorkspaceMemberDelete.
...
func (UnimplementedWorkspaceServiceHandler) WorkspaceList(context.Context, *connect.Request[emptypb.Empty]) (*connect.Response[v1.WorkspaceListResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("workspace.v1.WorkspaceService.WorkspaceList is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) WorkspaceGet(context.Context, *connect.Request[v1.WorkspaceGetRequest]) (*connect.Response[v1.WorkspaceGetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("workspace.v1.WorkspaceService.WorkspaceGet is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) WorkspaceCreate(context.Context, *connect.Request[v1.WorkspaceCreateRequest]) (*connect.Response[v1.WorkspaceCreateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("workspace.v1.WorkspaceService.WorkspaceCreate is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) WorkspaceUpdate(context.Context, *connect.Request[v1.WorkspaceUpdateRequest]) (*connect.Response[v1.WorkspaceUpdateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("workspace.v1.WorkspaceService.WorkspaceUpdate is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) WorkspaceDelete(context.Context, *connect.Request[v1.WorkspaceDeleteRequest]) (*connect.Response[v1.WorkspaceDeleteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("workspace.v1.WorkspaceService.WorkspaceDelete is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) WorkspaceMemberList(context.Context, *connect.Request[v1.WorkspaceMemberListRequest]) (*connect.Response[v1.WorkspaceMemberListResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("workspace.v1.WorkspaceService.WorkspaceMemberList is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) WorkspaceMemberCreate(context.Context, *connect.Request[v1.WorkspaceMemberCreateRequest]) (*connect.Response[v1.WorkspaceMemberCreateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("workspace.v1.WorkspaceService.WorkspaceMemberCreate is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) WorkspaceMemberUpdate(context.Context, *connect.Request[v1.WorkspaceMemberUpdateRequest]) (*connect.Response[v1.WorkspaceMemberUpdateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("workspace.v1.WorkspaceService.WorkspaceMemberUpdate is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) WorkspaceMemberDelete(context.Context, *connect.Request[v1.WorkspaceMemberDeleteRequest]) (*connect.Response[v1.WorkspaceMemberDeleteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("workspace.v1.WorkspaceService.WorkspaceMemberDelete is not implemented"))
}
