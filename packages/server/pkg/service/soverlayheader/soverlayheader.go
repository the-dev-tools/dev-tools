...
func (s *Service) SelectAsc(ctx context.Context, exampleID idwrap.IDWrap) ([]OrderRow, error) {
    ...
    for _, r := range rows { out = append(out, OrderRow{ RefKind: int8(r.RefKind), RefID: r.RefID, Rank: r.Rank, Revision: r.Revision }) }
    return out, nil
}
...
func (s *Service) MaxRevision(ctx context.Context, exampleID idwrap.IDWrap) (int64, error) {
    ...
    var max int64
    for _, r := range rows { if r.Revision > max { max = r.Revision } }
    return max, nil
}
...
func (s *Service) GetDelta(ctx context.Context, exampleID, id idwrap.IDWrap) (string, string, string, bool, bool, error) {
    ...
    if err != nil { if errors.Is(err, sql.ErrNoRows) { return "", "", "", false, false, nil }; return "", "", "", false, false, err }
...
func (s *Service) GetState(ctx context.Context, exampleID, originID idwrap.IDWrap) (StateRow, bool, error) {
    ...
    if err != nil { if errors.Is(err, sql.ErrNoRows) { return StateRow{}, false, nil }; return StateRow{}, false, err }
...
func (s *Service) ResolveExampleByDeltaID(ctx context.Context, id idwrap.IDWrap) (idwrap.IDWrap, bool, error) {
    ...
    if err != nil { if errors.Is(err, sql.ErrNoRows) { return idwrap.IDWrap{}, false, nil }; return idwrap.IDWrap{}, false, err }
