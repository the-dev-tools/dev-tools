...
SELECT id, node_id, state, input_data, input_data_compress_type, output_data, output_data_compress_type, error FROM node_execution WHERE node_id = ? ORDER BY id DESC
`
