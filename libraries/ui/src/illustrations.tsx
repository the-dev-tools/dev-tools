...
export const Logo = (props: React.ComponentPropsWithoutRef<'svg'>) => (
  <svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' fill='none' viewBox='0 0 24 20' {...props}>
    <path
      fill='url(#a)'
    ...
    />
    <defs>
      <linearGradient id='a' x1={-9.312} x2={21.745} y1={10.001} y2={10.001} gradientUnits='userSpaceOnUse'>
