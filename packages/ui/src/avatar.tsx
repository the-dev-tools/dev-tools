...
export const avatarStyles = tv({
  ...
  variants: {
    ...
    variant: {
      amber: tw`border-amber-500 bg-amber-100 text-amber-600 dark:border-amber-700 dark:bg-amber-900/40 dark:text-amber-400`,
      ...
      neutral: tw`border-border bg-surface text-fg`,
      ...
      violet: tw`border-violet-400 bg-violet-200 text-violet-600 dark:border-violet-700 dark:bg-violet-900/40 dark:text-violet-400`,
    },
  },
  defaultVariants: {
    shape: 'circle',
