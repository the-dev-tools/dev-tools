...
import { CollectionCreateEndpoint } from '@the-dev-tools/spec/data-client/collection/v1/collection.endpoints.js';
import {
  FlowCreateEndpoint,
  FlowDeleteEndpoint,
  FlowListEndpoint,
...
import { WorkspaceGetEndpoint } from '@the-dev-tools/spec/data-client/workspace/v1/workspace.endpoints.js';
