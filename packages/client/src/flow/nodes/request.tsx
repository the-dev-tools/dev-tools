...
import { CollectionGetEndpoint } from '@the-dev-tools/spec/data-client/collection/v1/collection.endpoints.js';
import {
  NodeGetEndpoint,
  NodeUpdateEndpoint,
} from '@the-dev-tools/spec/data-client/flow_item/node/v1/node.endpoints.js';
import { NodeRequest } from '@the-dev-tools/spec/flow_item/node/v1/node_pb';
