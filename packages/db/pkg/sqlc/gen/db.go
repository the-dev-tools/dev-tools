...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.getNodeExecutionsByFlowRunIDStmt, err = db.PrepareContext(ctx, getNodeExecutionsByFlowRunID); err != nil {
		return nil, fmt.Errorf("error preparing query GetNodeExecutionsByFlowRunID: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.getNodeExecutionsByFlowRunIDStmt != nil {
		if cerr := q.getNodeExecutionsByFlowRunIDStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getNodeExecutionsByFlowRunIDStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	getNodeExecutionsByFlowRunIDStmt                      *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		getNodeExecutionsByFlowRunIDStmt:                    q.getNodeExecutionsByFlowRunIDStmt,
