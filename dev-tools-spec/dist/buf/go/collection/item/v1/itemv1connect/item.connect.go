...
const (
	...
	CollectionItemServiceName = "collection.item.v1.CollectionItemService"
)
...
const (
	...
	CollectionItemServiceCollectionItemListProcedure = "/collection.item.v1.CollectionItemService/CollectionItemList"
	...
	CollectionItemServiceCollectionItemMoveProcedure = "/collection.item.v1.CollectionItemService/CollectionItemMove"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	collectionItemServiceServiceDescriptor                  = v1.File_collection_item_v1_item_proto.Services().ByName("CollectionItemService")
...
// CollectionItemServiceClient is a client for the collection.item.v1.CollectionItemService service.
...
// collection.item.v1.CollectionItemService service. By default, it uses the Connect protocol with
...
// CollectionItemList calls collection.item.v1.CollectionItemService.CollectionItemList.
...
// CollectionItemMove calls collection.item.v1.CollectionItemService.CollectionItemMove.
...
// CollectionItemServiceHandler is an implementation of the collection.item.v1.CollectionItemService
// service.
...
func NewCollectionItemServiceHandler(svc CollectionItemServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/collection.item.v1.CollectionItemService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedCollectionItemServiceHandler) CollectionItemList(context.Context, *connect.Request[v1.CollectionItemListRequest]) (*connect.Response[v1.CollectionItemListResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.item.v1.CollectionItemService.CollectionItemList is not implemented"))
}
...
func (UnimplementedCollectionItemServiceHandler) CollectionItemMove(context.Context, *connect.Request[v1.CollectionItemMoveRequest]) (*connect.Response[v1.CollectionItemMoveResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.item.v1.CollectionItemService.CollectionItemMove is not implemented"))
}
