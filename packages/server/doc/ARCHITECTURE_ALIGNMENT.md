...
As identified in the Audit (`BACKEND_DELTA_AUDIT.md`), the architecture _supports_ the requirement (via nullable columns), but the _converter logic_ fails to transmit the "Unset" state.
