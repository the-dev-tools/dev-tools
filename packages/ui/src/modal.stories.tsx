      ...
      <DialogTrigger onOpenChange={onOpenChange!}>
        ...
        <Modal {...props}>
          <Dialog className={tw`flex h-full flex-col p-4 outline-hidden`}>
            <h1 className={tw`mb-1 leading-5 font-semibold tracking-tight text-foreground`}>Delete workspace?</h1>
            <span className={tw`text-sm leading-5 font-medium tracking-tight text-muted-foreground`}>
