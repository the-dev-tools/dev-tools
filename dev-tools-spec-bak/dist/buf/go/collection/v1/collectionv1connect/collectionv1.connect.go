...
const (
	...
	CollectionServiceName = "collection.v1.collectionv1.CollectionService"
)
...
const (
	...
	// CollectionList RPC.
	CollectionServiceCollectionListProcedure = "/collection.v1.collectionv1.CollectionService/CollectionList"
	// CollectionServiceCollectionGetProcedure is the fully-qualified name of the CollectionService's
	// CollectionGet RPC.
	CollectionServiceCollectionGetProcedure = "/collection.v1.collectionv1.CollectionService/CollectionGet"
	// CollectionServiceCollectionCreateProcedure is the fully-qualified name of the CollectionService's
	// CollectionCreate RPC.
	CollectionServiceCollectionCreateProcedure = "/collection.v1.collectionv1.CollectionService/CollectionCreate"
	// CollectionServiceCollectionUpdateProcedure is the fully-qualified name of the CollectionService's
	// CollectionUpdate RPC.
	CollectionServiceCollectionUpdateProcedure = "/collection.v1.collectionv1.CollectionService/CollectionUpdate"
	// CollectionServiceCollectionDeleteProcedure is the fully-qualified name of the CollectionService's
	// CollectionDelete RPC.
	CollectionServiceCollectionDeleteProcedure = "/collection.v1.collectionv1.CollectionService/CollectionDelete"
	...
	CollectionServiceCollectionImportPostmanProcedure = "/collection.v1.collectionv1.CollectionService/CollectionImportPostman"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	collectionServiceServiceDescriptor                       = v1.File_collection_v1_collectionv1_proto.Services().ByName("CollectionService")
...
// CollectionServiceClient is a client for the collection.v1.collectionv1.CollectionService service.
...
// collection.v1.collectionv1.CollectionService service. By default, it uses the Connect protocol
...
// CollectionList calls collection.v1.collectionv1.CollectionService.CollectionList.
...
// CollectionGet calls collection.v1.collectionv1.CollectionService.CollectionGet.
...
// CollectionCreate calls collection.v1.collectionv1.CollectionService.CollectionCreate.
...
// CollectionUpdate calls collection.v1.collectionv1.CollectionService.CollectionUpdate.
...
// CollectionDelete calls collection.v1.collectionv1.CollectionService.CollectionDelete.
...
// CollectionImportPostman calls
// collection.v1.collectionv1.CollectionService.CollectionImportPostman.
...
// CollectionServiceHandler is an implementation of the collection.v1.collectionv1.CollectionService
// service.
...
func NewCollectionServiceHandler(svc CollectionServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/collection.v1.collectionv1.CollectionService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedCollectionServiceHandler) CollectionList(context.Context, *connect.Request[v1.CollectionListRequest]) (*connect.Response[v1.CollectionListResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.v1.collectionv1.CollectionService.CollectionList is not implemented"))
}
...
func (UnimplementedCollectionServiceHandler) CollectionGet(context.Context, *connect.Request[v1.CollectionGetRequest]) (*connect.Response[v1.CollectionGetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.v1.collectionv1.CollectionService.CollectionGet is not implemented"))
}
...
func (UnimplementedCollectionServiceHandler) CollectionCreate(context.Context, *connect.Request[v1.CollectionCreateRequest]) (*connect.Response[v1.CollectionCreateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.v1.collectionv1.CollectionService.CollectionCreate is not implemented"))
}
...
func (UnimplementedCollectionServiceHandler) CollectionUpdate(context.Context, *connect.Request[v1.CollectionUpdateRequest]) (*connect.Response[v1.CollectionUpdateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.v1.collectionv1.CollectionService.CollectionUpdate is not implemented"))
}
...
func (UnimplementedCollectionServiceHandler) CollectionDelete(context.Context, *connect.Request[v1.CollectionDeleteRequest]) (*connect.Response[v1.CollectionDeleteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.v1.collectionv1.CollectionService.CollectionDelete is not implemented"))
}
...
func (UnimplementedCollectionServiceHandler) CollectionImportPostman(context.Context, *connect.Request[v1.CollectionImportPostmanRequest]) (*connect.Response[v1.CollectionImportPostmanResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.v1.collectionv1.CollectionService.CollectionImportPostman is not implemented"))
}
