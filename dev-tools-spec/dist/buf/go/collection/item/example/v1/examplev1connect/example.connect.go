...
const (
	...
	ExampleServiceName = "collection.item.example.v1.ExampleService"
)
...
const (
	...
	// ExampleList RPC.
	ExampleServiceExampleListProcedure = "/collection.item.example.v1.ExampleService/ExampleList"
	// ExampleServiceExampleGetProcedure is the fully-qualified name of the ExampleService's ExampleGet
	// RPC.
	ExampleServiceExampleGetProcedure = "/collection.item.example.v1.ExampleService/ExampleGet"
	// ExampleServiceExampleCreateProcedure is the fully-qualified name of the ExampleService's
	// ExampleCreate RPC.
	ExampleServiceExampleCreateProcedure = "/collection.item.example.v1.ExampleService/ExampleCreate"
	// ExampleServiceExampleUpdateProcedure is the fully-qualified name of the ExampleService's
	// ExampleUpdate RPC.
	ExampleServiceExampleUpdateProcedure = "/collection.item.example.v1.ExampleService/ExampleUpdate"
	// ExampleServiceExampleDeleteProcedure is the fully-qualified name of the ExampleService's
	// ExampleDelete RPC.
	ExampleServiceExampleDeleteProcedure = "/collection.item.example.v1.ExampleService/ExampleDelete"
	// ExampleServiceExampleDuplicateProcedure is the fully-qualified name of the ExampleService's
	// ExampleDuplicate RPC.
	ExampleServiceExampleDuplicateProcedure = "/collection.item.example.v1.ExampleService/ExampleDuplicate"
	// ExampleServiceExampleRunProcedure is the fully-qualified name of the ExampleService's ExampleRun
	// RPC.
	ExampleServiceExampleRunProcedure = "/collection.item.example.v1.ExampleService/ExampleRun"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	exampleServiceServiceDescriptor                = v1.File_collection_item_example_v1_example_proto.Services().ByName("ExampleService")
...
// ExampleServiceClient is a client for the collection.item.example.v1.ExampleService service.
...
// NewExampleServiceClient constructs a client for the collection.item.example.v1.ExampleService
...
// ExampleList calls collection.item.example.v1.ExampleService.ExampleList.
...
// ExampleGet calls collection.item.example.v1.ExampleService.ExampleGet.
...
// ExampleCreate calls collection.item.example.v1.ExampleService.ExampleCreate.
...
// ExampleUpdate calls collection.item.example.v1.ExampleService.ExampleUpdate.
...
// ExampleDelete calls collection.item.example.v1.ExampleService.ExampleDelete.
...
// ExampleDuplicate calls collection.item.example.v1.ExampleService.ExampleDuplicate.
...
// ExampleRun calls collection.item.example.v1.ExampleService.ExampleRun.
...
// ExampleServiceHandler is an implementation of the collection.item.example.v1.ExampleService
// service.
...
func NewExampleServiceHandler(svc ExampleServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/collection.item.example.v1.ExampleService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedExampleServiceHandler) ExampleList(context.Context, *connect.Request[v1.ExampleListRequest]) (*connect.Response[v1.ExampleListResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.item.example.v1.ExampleService.ExampleList is not implemented"))
}
...
func (UnimplementedExampleServiceHandler) ExampleGet(context.Context, *connect.Request[v1.ExampleGetRequest]) (*connect.Response[v1.ExampleGetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.item.example.v1.ExampleService.ExampleGet is not implemented"))
}
...
func (UnimplementedExampleServiceHandler) ExampleCreate(context.Context, *connect.Request[v1.ExampleCreateRequest]) (*connect.Response[v1.ExampleCreateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.item.example.v1.ExampleService.ExampleCreate is not implemented"))
}
...
func (UnimplementedExampleServiceHandler) ExampleUpdate(context.Context, *connect.Request[v1.ExampleUpdateRequest]) (*connect.Response[v1.ExampleUpdateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.item.example.v1.ExampleService.ExampleUpdate is not implemented"))
}
...
func (UnimplementedExampleServiceHandler) ExampleDelete(context.Context, *connect.Request[v1.ExampleDeleteRequest]) (*connect.Response[v1.ExampleDeleteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.item.example.v1.ExampleService.ExampleDelete is not implemented"))
}
...
func (UnimplementedExampleServiceHandler) ExampleDuplicate(context.Context, *connect.Request[v1.ExampleDuplicateRequest]) (*connect.Response[v1.ExampleDuplicateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.item.example.v1.ExampleService.ExampleDuplicate is not implemented"))
}
...
func (UnimplementedExampleServiceHandler) ExampleRun(context.Context, *connect.Request[v1.ExampleRunRequest]) (*connect.Response[v1.ExampleRunResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.item.example.v1.ExampleService.ExampleRun is not implemented"))
}
