// TODO: HTTP body raw service is not implemented yet.
// The database schema exists but SQLC queries are missing.
// This file is commented out until the queries are added.
