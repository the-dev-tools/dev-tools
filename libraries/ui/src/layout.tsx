...
export const WithBackground = ({ src, className, innerClassName, children, ...props }: WithBackgroundProps) => (
  <div {...props} className={twMerge('relative z-0 size-full bg-slate-50 font-sans', className)}>
    <div className='absolute inset-x-0 top-0 -z-10 bg-slate-50'>
      <img src={src} alt='Background' className='w-full mix-blend-luminosity' />
