...
const (
	...
	VariableServiceName = "variable.v1.variablev1.VariableService"
)
...
const (
	...
	// VariableList RPC.
	VariableServiceVariableListProcedure = "/variable.v1.variablev1.VariableService/VariableList"
	// VariableServiceVariableGetProcedure is the fully-qualified name of the VariableService's
	// VariableGet RPC.
	VariableServiceVariableGetProcedure = "/variable.v1.variablev1.VariableService/VariableGet"
	// VariableServiceVariableCreateProcedure is the fully-qualified name of the VariableService's
	// VariableCreate RPC.
	VariableServiceVariableCreateProcedure = "/variable.v1.variablev1.VariableService/VariableCreate"
	// VariableServiceVariableUpdateProcedure is the fully-qualified name of the VariableService's
	// VariableUpdate RPC.
	VariableServiceVariableUpdateProcedure = "/variable.v1.variablev1.VariableService/VariableUpdate"
	// VariableServiceVariableDeleteProcedure is the fully-qualified name of the VariableService's
	// VariableDelete RPC.
	VariableServiceVariableDeleteProcedure = "/variable.v1.variablev1.VariableService/VariableDelete"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	variableServiceServiceDescriptor              = v1.File_variable_v1_variablev1_proto.Services().ByName("VariableService")
...
// VariableServiceClient is a client for the variable.v1.variablev1.VariableService service.
...
// NewVariableServiceClient constructs a client for the variable.v1.variablev1.VariableService
...
// VariableList calls variable.v1.variablev1.VariableService.VariableList.
...
// VariableGet calls variable.v1.variablev1.VariableService.VariableGet.
...
// VariableCreate calls variable.v1.variablev1.VariableService.VariableCreate.
...
// VariableUpdate calls variable.v1.variablev1.VariableService.VariableUpdate.
...
// VariableDelete calls variable.v1.variablev1.VariableService.VariableDelete.
...
// VariableServiceHandler is an implementation of the variable.v1.variablev1.VariableService
// service.
...
func NewVariableServiceHandler(svc VariableServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/variable.v1.variablev1.VariableService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedVariableServiceHandler) VariableList(context.Context, *connect.Request[v1.VariableListRequest]) (*connect.Response[v1.VariableListResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("variable.v1.variablev1.VariableService.VariableList is not implemented"))
}
...
func (UnimplementedVariableServiceHandler) VariableGet(context.Context, *connect.Request[v1.VariableGetRequest]) (*connect.Response[v1.VariableGetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("variable.v1.variablev1.VariableService.VariableGet is not implemented"))
}
...
func (UnimplementedVariableServiceHandler) VariableCreate(context.Context, *connect.Request[v1.VariableCreateRequest]) (*connect.Response[v1.VariableCreateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("variable.v1.variablev1.VariableService.VariableCreate is not implemented"))
}
...
func (UnimplementedVariableServiceHandler) VariableUpdate(context.Context, *connect.Request[v1.VariableUpdateRequest]) (*connect.Response[v1.VariableUpdateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("variable.v1.variablev1.VariableService.VariableUpdate is not implemented"))
}
...
func (UnimplementedVariableServiceHandler) VariableDelete(context.Context, *connect.Request[v1.VariableDeleteRequest]) (*connect.Response[v1.VariableDeleteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("variable.v1.variablev1.VariableService.VariableDelete is not implemented"))
}
