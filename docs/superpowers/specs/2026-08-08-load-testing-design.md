...
3. **Fix `run:` ordering**: topological sort from `depends_on`; **warn** on unknown dep
   names (still ignored, as before) and **error** on cycles and duplicate flow names.
   ⚠️ Behavior change — see 4.2.
