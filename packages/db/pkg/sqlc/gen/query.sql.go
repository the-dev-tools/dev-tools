...
type GetHeaderByDeltaParentIDRow struct {
	ID            idwrap.IDWrap
	ExampleID     idwrap.IDWrap
	DeltaParentID *idwrap.IDWrap
	HeaderKey     string
...
func (q *Queries) GetHeaderByDeltaParentID(ctx context.Context, deltaParentID *idwrap.IDWrap) (GetHeaderByDeltaParentIDRow, error) {
	row := q.queryRow(ctx, q.getHeaderByDeltaParentIDStmt, getHeaderByDeltaParentID, deltaParentID)
	var i GetHeaderByDeltaParentIDRow
	err := row.Scan(
		&i.ID,
		&i.ExampleID,
		&i.DeltaParentID,
...
type GetHeadersByExampleIDRow struct {
	ID            idwrap.IDWrap
	ExampleID     idwrap.IDWrap
	DeltaParentID *idwrap.IDWrap
	HeaderKey     string
...
func (q *Queries) GetHeadersByExampleID(ctx context.Context, exampleID idwrap.IDWrap) ([]GetHeadersByExampleIDRow, error) {
	rows, err := q.query(ctx, q.getHeadersByExampleIDStmt, getHeadersByExampleID, exampleID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	items := []GetHeadersByExampleIDRow{}
	for rows.Next() {
		var i GetHeadersByExampleIDRow
		if err := rows.Scan(
			&i.ID,
			&i.ExampleID,
			&i.DeltaParentID,
...
func (q *Queries) GetHeadersByExampleIDOrdered(ctx context.Context, exampleID idwrap.IDWrap) ([]ExampleHeader, error) {
	rows, err := q.query(ctx, q.getHeadersByExampleIDOrderedStmt, getHeadersByExampleIDOrdered, exampleID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
type GetQueriesByExampleIDRow struct {
	ID            idwrap.IDWrap
	ExampleID     idwrap.IDWrap
	DeltaParentID *idwrap.IDWrap
	QueryKey      string
...
func (q *Queries) GetQueriesByExampleID(ctx context.Context, exampleID idwrap.IDWrap) ([]GetQueriesByExampleIDRow, error) {
	rows, err := q.query(ctx, q.getQueriesByExampleIDStmt, getQueriesByExampleID, exampleID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	items := []GetQueriesByExampleIDRow{}
	for rows.Next() {
		var i GetQueriesByExampleIDRow
		if err := rows.Scan(
			&i.ID,
			&i.ExampleID,
			&i.DeltaParentID,
...
const getQueriesByExampleIDOrdered = `-- name: GetQueriesByExampleIDOrdered :many
SELECT
  id,
  example_id,
  delta_parent_id,
...
func (q *Queries) GetQueriesByExampleIDOrdered(ctx context.Context, exampleID idwrap.IDWrap) ([]ExampleQuery, error) {
	rows, err := q.query(ctx, q.getQueriesByExampleIDOrderedStmt, getQueriesByExampleIDOrdered, exampleID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
type GetQueryByDeltaParentIDRow struct {
	ID            idwrap.IDWrap
	ExampleID     idwrap.IDWrap
	DeltaParentID *idwrap.IDWrap
	QueryKey      string
...
func (q *Queries) GetQueryByDeltaParentID(ctx context.Context, deltaParentID *idwrap.IDWrap) (GetQueryByDeltaParentIDRow, error) {
	row := q.queryRow(ctx, q.getQueryByDeltaParentIDStmt, getQueryByDeltaParentID, deltaParentID)
	var i GetQueryByDeltaParentIDRow
	err := row.Scan(
		&i.ID,
		&i.ExampleID,
		&i.DeltaParentID,
...
func (q *Queries) UpdateHeaderNext(ctx context.Context, arg UpdateHeaderNextParams) error {
	_, err := q.exec(ctx, q.updateHeaderNextStmt, updateHeaderNext, arg.Next, arg.ID)
	return err
}
...
func (q *Queries) UpdateHeaderOrder(ctx context.Context, arg UpdateHeaderOrderParams) error {
	_, err := q.exec(ctx, q.updateHeaderOrderStmt, updateHeaderOrder, arg.Prev, arg.Next, arg.ID)
	return err
}
...
func (q *Queries) UpdateHeaderPrev(ctx context.Context, arg UpdateHeaderPrevParams) error {
	_, err := q.exec(ctx, q.updateHeaderPrevStmt, updateHeaderPrev, arg.Prev, arg.ID)
	return err
}
...
const updateQueryNext = `-- name: UpdateQueryNext :exec
UPDATE example_query
SET next = ?
WHERE id = ?
`
...
func (q *Queries) UpdateQueryNext(ctx context.Context, arg UpdateQueryNextParams) error {
	_, err := q.exec(ctx, q.updateQueryNextStmt, updateQueryNext, arg.Next, arg.ID)
	return err
}

const updateQueryOrder = `-- name: UpdateQueryOrder :exec
UPDATE example_query
SET prev = ?, next = ?
WHERE id = ?
`
...
func (q *Queries) UpdateQueryOrder(ctx context.Context, arg UpdateQueryOrderParams) error {
	_, err := q.exec(ctx, q.updateQueryOrderStmt, updateQueryOrder, arg.Prev, arg.Next, arg.ID)
	return err
}

const updateQueryPrev = `-- name: UpdateQueryPrev :exec
UPDATE example_query
SET prev = ?
WHERE id = ?
`
...
func (q *Queries) UpdateQueryPrev(ctx context.Context, arg UpdateQueryPrevParams) error {
	_, err := q.exec(ctx, q.updateQueryPrevStmt, updateQueryPrev, arg.Prev, arg.ID)
	return err
}
