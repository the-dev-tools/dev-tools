...
const (
	...
	FolderServiceName = "collection.item.folder.v1.folderv1.FolderService"
)
...
const (
	...
	// FolderCreate RPC.
	FolderServiceFolderCreateProcedure = "/collection.item.folder.v1.folderv1.FolderService/FolderCreate"
	// FolderServiceFolderUpdateProcedure is the fully-qualified name of the FolderService's
	// FolderUpdate RPC.
	FolderServiceFolderUpdateProcedure = "/collection.item.folder.v1.folderv1.FolderService/FolderUpdate"
	// FolderServiceFolderDeleteProcedure is the fully-qualified name of the FolderService's
	// FolderDelete RPC.
	FolderServiceFolderDeleteProcedure = "/collection.item.folder.v1.folderv1.FolderService/FolderDelete"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	folderServiceServiceDescriptor            = v1.File_collection_item_folder_v1_folderv1_proto.Services().ByName("FolderService")
...
// FolderServiceClient is a client for the collection.item.folder.v1.folderv1.FolderService service.
...
// NewFolderServiceClient constructs a client for the
// collection.item.folder.v1.folderv1.FolderService service. By default, it uses the Connect
...
// FolderCreate calls collection.item.folder.v1.folderv1.FolderService.FolderCreate.
...
// FolderUpdate calls collection.item.folder.v1.folderv1.FolderService.FolderUpdate.
...
// FolderDelete calls collection.item.folder.v1.folderv1.FolderService.FolderDelete.
...
// FolderServiceHandler is an implementation of the collection.item.folder.v1.folderv1.FolderService
// service.
...
func NewFolderServiceHandler(svc FolderServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/collection.item.folder.v1.folderv1.FolderService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedFolderServiceHandler) FolderCreate(context.Context, *connect.Request[v1.FolderCreateRequest]) (*connect.Response[v1.FolderCreateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.item.folder.v1.folderv1.FolderService.FolderCreate is not implemented"))
}
...
func (UnimplementedFolderServiceHandler) FolderUpdate(context.Context, *connect.Request[v1.FolderUpdateRequest]) (*connect.Response[v1.FolderUpdateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.item.folder.v1.folderv1.FolderService.FolderUpdate is not implemented"))
}
...
func (UnimplementedFolderServiceHandler) FolderDelete(context.Context, *connect.Request[v1.FolderDeleteRequest]) (*connect.Response[v1.FolderDeleteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("collection.item.folder.v1.folderv1.FolderService.FolderDelete is not implemented"))
}
