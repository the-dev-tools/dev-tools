...
func (r *Reader) GetFlowVariable(ctx context.Context, id idwrap.IDWrap) (mflow.FlowVariable, error) {
...
func (r *Reader) GetFlowVariablesByFlowID(ctx context.Context, flowID idwrap.IDWrap) ([]mflow.FlowVariable, error) {
...
func (r *Reader) GetFlowVariablesByFlowIDOrdered(ctx context.Context, flowID idwrap.IDWrap) ([]mflow.FlowVariable, error) {
