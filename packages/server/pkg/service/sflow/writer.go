...
func (w *Writer) CreateFlow(ctx context.Context, item mflow.Flow) error {
...
func (w *Writer) CreateFlowBulk(ctx context.Context, flows []mflow.Flow) error {
	batchSize := 10
...
func (w *Writer) UpdateFlow(ctx context.Context, flow mflow.Flow) error {
...
func (w *Writer) DeleteFlow(ctx context.Context, id idwrap.IDWrap) error {
...
func (w *Writer) CreateFlowVersion(ctx context.Context, parentFlow mflow.Flow) (mflow.Flow, error) {
